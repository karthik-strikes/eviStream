...
This field captures essential demographic information needed for medical case analysis and age-specific treatment considerations."""

    markdown_content: str = dspy.InputField(
        desc="""Full markdown content of the document to extract patient age from"""
    )
...
This field captures demographic information typically found in patient records and medical documentation."""
...
- Look for gender information in patient demographics, header, or intake sections
- If document uses synonyms (e.g., "M", "man"), map to "Male"; "F", "woman" to "Female"
- Use "NR" if not reported or value is missing
